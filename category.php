...
// Get posts by category with prepared statement
...
<head>
    ...
    <meta name="description" content="PIXELBYTE Blog - Posts in the <?php echo htmlspecialchars($category_name); ?> category">
    
    <!-- Open Graph Meta Tags -->
    <meta property="og:title" content="<?php echo htmlspecialchars($category_name); ?> - PIXELBYTE Blog">
    <meta property="og:description" content="Browse articles in the <?php echo htmlspecialchars($category_name); ?> category">
    <meta property="og:url" content="<?php echo 'https://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']; ?>">
    <meta property="og:type" content="website">
    
    <title><?php echo htmlspecialchars($category_name); ?> - PIXELBYTE Blog</title>
    ...
    <style>
        ...
        *, *::before, *::after {
        ...
        .category-hero::before {
            ...
            width: 100%;
            height: 100%;
            background: linear-gradient(135deg, rgba(126, 87, 194, 0.1) 0%, rgba(38, 166, 154, 0.1) 100%);
            z-index: -1;
        }
...
<body>
    ...
    <section class="category-hero">
        <div class="container">
            <h1 class="category-hero-title"><?php echo htmlspecialchars($category_name); ?></h1>
            <p class="category-hero-text">Browse all articles in the <?php echo htmlspecialchars($category_name); ?> category</p>
        </div>
        <div class="category-hero-shape shape-1"></div>
        <div class="category-hero-shape shape-2"></div>
    </section>
            ...
            <main class="blog-content">
                <?php if($posts_result->num_rows > 0): ?>
                    ...
                    <div class="blog-posts-grid">
                        ...
                        while($post = $posts_result->fetch_assoc()): 
                            ...
                            $index++;
                        ?>
                        <article class="blog-card fade-in-up <?php echo $delay_class; ?>">
                            ...
                            <div class="blog-card-content">
                                ...
                                <div class="blog-card-footer">
                                    <a href="post.php?id=<?php echo $post['id']; ?>" class="btn">Read Article</a>
                ...
                <?php else: ?>
                    <div class="no-posts">
                        ...
                        <p>There are currently no posts in the "<?php echo htmlspecialchars($category_name); ?>" category.</p>
                        ...
                        if ($categories_result && $categories_result->num_rows > 0) {
                            ...
                            while($category = $categories_result->fetch_assoc()): 
                                if (isset($category['category'])):
                                    $is_current = ($category['category'] == $category_name);
                        ?>
                        <li>
                            <a href="category.php?name=<?php echo urlencode($category['category']); ?>" <?php if($is_current) echo 'style="color: var(--primary); font-weight: 700;"'; ?>>
                        ...
                        <div class="popular-post">
                            ...
                            <div class="popular-post-content">
                                <h4 class="popular-post-title">
                                    <a href="post.php?id=<?php echo $popular['id']; ?>"><?php echo htmlspecialchars($popular['title']); ?></a>
                                </h4>
        ...
        <div class="container">
            <div class="footer-content">
                <div>
                    ...
                    <p>Creating unique digital experiences that break the conventional mold with modern glassmorphic design.</p>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            // Add fade-in animations to blog cards
            ...
            const cards = document.querySelectorAll('.blog-card, .sidebar-section');
